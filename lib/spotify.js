...
- If it mentions celebrities/artists (e.g., "Sabrina Carpenter", "Taylor Swift"), research their typical aesthetic, fanbase music taste, and include songs they're known for or that match their vibe
- If it mentions content type (e.g., "Minecraft", "anime", "gym workout"), tailor songs to that audience and use case
- If it mentions specific moods (e.g., "sad", "hype", "aesthetic"), prioritize that mood over the detected vibe
- Match the audio to what would actually play in this type of edit on TikTok/Instagram
